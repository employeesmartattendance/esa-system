    ...
    <nav class="site-nav" :class="{ scrolled: scrolled }">
      <div class="nav-inner">
        ...
        <div class="nav-links">
          <a
            ...
            @click.prevent="navTo('#how-it-works')"
            >How It Works</a
          >
          <a
            href="#features"
          ...
          <a
            ...
            @click.prevent="navTo('#download')"
            >Download</a
          >
          <a
            href="#trusted"
            class="nav-link"
            :class="{ active: activeSection === 'trusted' }"
            @click.prevent="navTo('#trusted')"
            >Schools</a
          >
          <a
            href="#contact"
      ...
      <div class="mobile-menu" :class="{ open: mobileOpen }">
        <a
          href="#how-it-works"
          class="mob-link"
          @click.prevent="navTo('#how-it-works', true)"
          >How It Works</a
        >
        <a
          href="#features"
          class="mob-link"
          @click.prevent="navTo('#features', true)"
          >Features</a
        >
        <a
          href="#download"
          class="mob-link"
          @click.prevent="navTo('#download', true)"
          >Download</a
        >
        <a
          href="#trusted"
          class="mob-link"
          @click.prevent="navTo('#trusted', true)"
          >Schools</a
        >
        <a
          href="#contact"
          class="mob-link"
          @click.prevent="navTo('#contact', true)"
          >Contact</a
        >
        <div class="mob-cta">
          <a
      ...
      <div class="container">
        <div class="hero-inner">
          ...
          <div class="hero-left">
            ...
            <p class="hero-desc">
              ESA uses GPS &amp; Wi-Fi technology to automate teacher attendance
              tracking — real-time dashboards, instant reports, and multi-school
            ...
            <div class="hero-stats">
              <div class="hero-stat">
                <div class="hstat-val">{{ schoolCount }}</div>
                <div class="hstat-lbl">Active Schools</div>
              </div>
              <div class="hero-stat">
                <div class="hstat-val">99.9%</div>
                <div class="hstat-lbl">Uptime</div>
              </div>
              <div class="hero-stat">
                <div class="hstat-val">&lt;50ms</div>
                <div class="hstat-lbl">Real-time</div>
              </div>
            </div>
          </div>
          ...
          <div class="hero-right">
            <div class="hero-card glass-lg">
              ...
              <div class="hc-stats">
                <div class="hc-stat">
                  <div class="hcs-val" style="color: var(--success)">18</div>
                  <div class="hcs-lbl">Present</div>
                </div>
                <div class="hc-stat">
                  <div class="hcs-val" style="color: var(--warning)">3</div>
                  <div class="hcs-lbl">Late</div>
                </div>
                <div class="hc-stat">
                  <div class="hcs-val" style="color: var(--danger)">2</div>
                  <div class="hcs-lbl">Absent</div>
                </div>
              </div>
              <div class="hc-teachers">
                <div class="hc-teacher" v-for="t in heroTeachers" :key="t.name">
                  <div class="hc-av" :style="`background:${t.bg}`">
                    {{ t.init }}
                  </div>
                  <div class="hc-tname">{{ t.name }}</div>
                  <span class="hc-status" :class="t.status">{{
                    t.status
                  }}</span>
                </div>
              </div>
            ...
            <div class="glass hero-float hero-float-r">
              ...
              <div>
                <div class="float-lbl">GPS Verified</div>
                <div class="float-val" style="color: var(--success)">
                  ✓ On campus
                </div>
              </div>
            </div>
            <div class="glass hero-float hero-float-l">
              ...
              <div>
                <div class="float-lbl">Attendance Rate</div>
                <div class="float-val" style="color: var(--primary)">87.5%</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="section-header-center">
          ...
          <p class="section-desc mx-auto">
            From school setup to daily attendance — ESA makes the entire process
            effortless in four simple steps.
          </p>
        </div>
      ...
      <div class="container">
        <div>
          ...
          <p class="section-desc">
            A complete attendance management platform built specifically for
    ...
    <section id="download" class="section-pad download-bg">
      <div class="container">
        <div class="section-header-center">
          ...
          <p class="section-desc mx-auto">
            ESA runs natively on Android, iOS, and desktop — teachers can check
            in from any device, anywhere on campus.
          </p>
        </div>
        <div class="download-grid">
          ...
          <div class="glass download-card">
            ...
            <div class="dc-stores">
              ...
              >
                ...
                >
                  <path
                    d="M3.18 23.76c.3.17.64.24.99.18l.06-.03 11.35-6.54-2.47-2.46-9.93 8.85zM.54 2.28C.2 2.6 0 3.13 0 3.84v16.32c0 .71.2 1.24.55 1.55l.08.07L9.6 12.8v-.22L.62 2.22l-.08.06zM19.94 10.54l-2.89-1.67-2.77 2.76 2.77 2.77 2.9-1.67c.83-.48.83-1.25-.01-2.19zM4.17.24L15.52 6.78l-2.47 2.47L3.12.4l.06-.03c.34-.07.68 0 .99.17z"
                  />
                </svg>
                <div>
          ...
          <div class="glass download-card">
            ...
            <div class="dc-stores">
              <a
                :href="`${apiBase}/downloads/windows`"
                class="store-btn"
                download
              >
                <svg
    ...
    <section id="trusted" class="section-pad">
      <div class="container">
        <div class="section-header-center">
          ...
          <p class="section-desc mx-auto">
            Join the growing community of schools that rely on ESA for accurate,
      ...
      <div class="container">
        <div class="contact-grid">
          ...
          <div>
            ...
            <p class="section-desc">
              Fill out the form and our team will set up ESA for your school. No
              complex installation — we guide you through every step.
            </p>
          ...
          <div class="glass contact-form-card">
            ...
            <p
              ...
              "
            >
              You'll receive a confirmation email and we'll be in touch shortly.
            </p>
            ...
            >
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  placeholder="Tell us about your school, number of teachers, or any questions..."
                />
              </div>
              <button
                type="submit"
      ...
      <div class="container">
        <div class="footer-grid">
          <div>
            ...
            <p class="footer-tagline">
              Employee Smart Attendance — automated, verified GPS &amp; Wi-Fi
              attendance for modern schools.
            </p>
          </div>
          <div>
        ...
        <div class="footer-bottom">
          <span class="footer-copy"
            >© {{ new Date().getFullYear() }} ESA — Employee Smart Attendance
            System. All rights reserved.</span
          >
...
// ── API base ─────────────────────────────────────────────────
const API = import.meta.env.VITE_API_URL || "https://esasystem.onrender.com/api";
...
onMounted(async () => {
  try {
    const r = await fetch(`${API}/website/schools-count`);
    const d = await r.json();
    if (d.success && d.data.active > 0) schoolCount.value = d.data.active + "+";
  } catch {}
});
...
const trustedDouble = computed(() => {
  let list = trustedSchools.value.length
    ? trustedSchools.value
    : [
        { name: "Green Hills Academy" },
        { name: "College of Excellence" },
        { name: "Kigali Secondary" },
...
onMounted(async () => {
  try {
    const r = await fetch(`${API}/website/trusted-schools`);
    const d = await r.json();
    if (d.success && d.data.length) trustedSchools.value = d.data;
  } catch {}
});
...
const features = [
  ...
  {
    title: "Wi-Fi Network Validation",
    iconBg: "rgba(6,182,212,0.1)",
    svgProps: {
      width: 26,
      height: 26,
...
const desktopFeatures = [
  ...
  "Live map with teacher locations",
...
const contactInfo = [
  {
    ...
    svgPath:
      '<path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81a19.79 19.79 0 01-3.07-8.68A2 2 0 012 1h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16v.92z"/>',
  },
  {
    label: "Setup Process",
    val: "Guided onboarding, free",
...
async function submitContact() {
  ...
  formMsg.value = null;
  try {
    const r = await fetch(`${API}/website/contact`, {
      method: "POST",
    ...
    if (d.success) {
      formMsg.value = {
        type: "success",
        text: "Request sent! Check your email for confirmation.",
      };
      Object.assign(form, {
        full_name: "",
        email: "",
...
.school-badge:hover .school-tooltip {
  opacity: 1;
}
...
@media (max-width: 768px) {
  ...
  .hero-right {
    order: 2; /* card below text on mobile */
  }
  .hero-float {
    display: none;
  }
