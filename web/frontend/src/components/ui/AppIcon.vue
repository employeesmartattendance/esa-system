...
const icons = {
  ...
  teachers: '<path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/>',
  attendance: '<rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M9 16l2 2 4-4"/>',
  settings: '<circle cx="12" cy="12" r="3"/><path d="M19.07 4.93l-1.41 1.41M4.93 4.93l1.41 1.41M12 2v2M12 20v2M4.93 19.07l1.41-1.41M19.07 19.07l-1.41-1.41M2 12h2M20 12h2"/>',
  ...
  fingerprint: '<path d="M12 2a9 9 0 0 0-9 9c0 1.5.3 2.9.8 4.2"/><path d="M17.5 5.5A7.9 7.9 0 0 0 12 3a8 8 0 0 0-8 8c0 1.6.3 3 .9 4.4"/><path d="M12 6a6 6 0 0 0-6 6c0 2 .4 4.2 1.2 6.2"/><path d="M12 9a3 3 0 0 0-3 3c0 3 1 6 2 8"/><path d="M12 9a3 3 0 0 1 3 3c0 1.5-.1 3-.5 4.5"/><path d="M17.5 18.5c.4-1.6.5-3 .5-4.5a6 6 0 0 0-1-3.3"/><path d="M20 15.5c.3-1.3.5-2.7.5-4.5a8 8 0 0 0-1.5-4.7"/><path d="M9.5 22c-.4-.9-.7-1.7-1-2.5"/>',
  key: '<path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 11-7.778 7.778 5.5 5.5 0 017.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"/>',
  'bar-chart': '<line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/>',
  layers: '<polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/>',
  'live': '<circle cx="12" cy="12" r="3" fill="currentColor"/><path d="M5.2 5.2A9 9 0 1118.8 18.8"/><path d="M8.05 8.05A6 6 0 1115.95 15.95"/>',
  ...
  checkin: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/><path d="M16 17l2-2-2-2"/>',
